...
public class PngExporter
{
    ...
    private const float NodeStrokeWidth = 2.0f;
    private const float LineStrokeWidth = 2.0f;
    ...
    public void ExportToPng(LayoutNode rootLayout, string filePath)
    {
        ...
        // Add margins
        float margin = 20.0f;
        int imageWidth = (int)(bounds.Width + (2 * margin));
        int imageHeight = (int)(bounds.Height + (2 * margin));
